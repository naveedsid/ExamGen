...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1 class="d-inline-block">Question Bank<small>Questions</small></h1>
                    ...
                    <div class="box-body">
                        <table id="init_datatable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php //$manage_users_record['MU_ID']; ?></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <a class="btn btn-primary btn-xs mr-btn" data-toggle="tooltip" title="" href="/manage_users/edit/" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a class="btn btn-danger btn-xs mr-btb" data-toggle="tooltip" title="" href="/manage_users/delete/" data-original-title="Delete" onclick="return confirm('Are You Sure you want to Delete Record ?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                //}
